...
* 문제2-  양도 기능 <br>
 ...
 문제점 : 
 예약 건을 다른 사람에게 양도, 양수
양도자는 취소 수수료 부담 감소, 양수자는 가고 싶은 곳을 저렴한 가격에  받을 수 있음. 

* 문제3 -예약 서비스  <br>
 문제점 설명 및 해결방안
 문제점 : 
 비동기 날짜 선택 및 확인
 : 달력을 직접 만들어 체크인, 체크아웃 날짜 선택하여 예약의 가능 여부를 확인 -> 날짜 별 방 정보를 통하여 예약이 가능하다면 예약하기 서비스를 지원
 

 
* 문제4 - 설문조사 기능  <br>
 문제점 설명 및 해결방안
 문제점 : 설문조사가 끝난후 설문조사의 대한 값을 서비스로 값이 안넘어가짐
 해결방안 : ajax를 이용해 딕셔너리로 묶어 값을 파라미터값으로 받아서 해결됨

* 문제5 - 사용자 맞춤 추천 기능(카테고리)  <br>
 문제점 설명 및 해결방안
 문제점 :
 카테고리로 검색과 유사한 기능인데 위 기능을 구현하기 위해서 필터링이 필요했으며, 사용자가 검색한 항목을 태그를 이용한 검색과 일반 검색과 같이 구분하는 것이 필요했다
