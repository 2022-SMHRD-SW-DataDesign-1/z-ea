...
//		String mb_email = (String) request.getAttribute("mb_email");
		BigDecimal data = new BigDecimal(request.getParameter("mb_age"));
...
//		SurveyDTO2 dto2 = new SurveyDTO2(mb_email, data, data1, data2, data3, data4, data5, data6);
