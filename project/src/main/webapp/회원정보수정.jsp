...
<body>
	...
	<div class="cities-town"
		style="display: inline-block; margin-left: 550px; margin-top: 50px;text-align: center;">
		<div class="container">
			<div class="row">
				<div class="slider-content">

					<div class="row"
						style="display:inline-block; padding-left: 5px; padding-bottom: 10px; padding-right: 5px; padding-top: 10px;">
						<h2 style="margin-bottom: 60px;">회원정보</h2>
										...
										<div class="col-lg-6">
												<fieldset style="width: 350px;">
													<label for="Name" class="form-label">Name</label> <input
														...
														style="padding: 5px, 10px, 5px, 10px;" autocomplete="on"
														required>
												</fieldset>
											</div>
											<!-- 전화번호 -->
											<div class="col-lg-6">
												<fieldset style="width: 350px;">
													<label for="Number" class="form-label"
														style="margin:5px;float:left;">Phone Number</label> <input
											...
											<!-- 패스워드 -->
											<div class="col-lg-6">
												<fieldset style="width: 350px;mergin-top:5px;">
													<label for="password" class="form-label"
														style="margin: 5px;">Password</label> <input
											...
											<div class="col-lg-12" style="text-align: center;">
												<fieldset style="margin-top: 5px;">
													<label for="Number" class="form-label" style="margin: 5px;">Birth</label>
													<input type="date" name="mb_birthdate" class="date"
														required>
												</fieldset>
											</div>

											<div class="col-lg-12"
												style="padding: 5px 10px 5px 10px; margin-top: 10px;">
												<fieldset>
													<button type="submit" class="main-button"
														style="padding: 12px; border: none; border-radius: 15px; color: white; font-size: 18px; font-weight: bold; background-color: #6A5ACD;">Save</button>
												</fieldset>
											</div>
										</form>
								</div>
