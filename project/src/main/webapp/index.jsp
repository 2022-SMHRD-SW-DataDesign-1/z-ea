				...
				<div class="main-caption" style="font-size: 20px;">
					...
					<form action="get">
						<input type="text" placeholder="#여행"
							style="width: 30%; height: 40px;" /> <input type="submit"
							value="검색" />
					</form>
					<p>#여행 #먹방 기타등등</p>
				</div>
				...
				<div class="modalPopup" style="display: none;">
					...
					<div class="LoginModal"
						...
						<table style="margin: auto; margin-top: 10%;">
							<th colspan="2"
								style="font-size: 20px; padding: 10px; text-align: center;">로그인</th>
							<tr>
								<td>
									<div
						...
						<table style="margin: auto; margin-top: 10%;">
							<th colspan="2"
								style="font-size: 20px; padding: 10px; text-align: center;">회원가입</th>
							<tr>
								<td>
									<div
